\documentclass[9pt,shortpaper,twoside,web]{ieeecolor2}
\usepackage{generic}
\usepackage{cite}
...
{Author \MakeLowercase{\textit{et al.}}: Preparation of Brief Papers for IEEE TRANSACTIONS and JOURNALS (December 2023)}
\begin{document}
\title{Preparation of Brief Papers for IEEE TRANSACTIONS and JOURNALS (December 2023)}
...
e-mail to keywords@ieee.org or visit \underline{$\small
